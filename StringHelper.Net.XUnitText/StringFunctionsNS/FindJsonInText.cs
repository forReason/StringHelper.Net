...
public class FindJsonInText
{
    ...
    [InlineData("Here is the decision as a JSON object:\n\n```\n{\n  \"awaitingCustomerResponse\": false,\n  \"justification\": \"The customer has responded to the Project Manager's message, therefore we proceed with setting awaitingCustomerResponse to false.\"\n}\n```", "{\n  \"awaitingCustomerResponse\": false,\n  \"justification\": \"The customer has responded to the Project Manager's message, therefore we proceed with setting awaitingCustomerResponse to false.\"\n}")]
